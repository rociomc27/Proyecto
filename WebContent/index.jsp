		...
		<main>
    		...
    		<div>
    			<form id="form_index" action="" method="post">
    				<p><input id="caja_index" type="text" name="texto" placeholder= "Nombre de Usuario" size="50" ></p>
    				...
    				<input id="inicio_sesion" type="submit" name="submit_button" value="∞ Inicio Sesión ∞">
    				 <a id="enlace_registrarse" href="signup.jsp">Registrarse</a>
    			</form>
